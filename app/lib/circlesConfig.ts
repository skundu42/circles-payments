...
/** Gnosis Chain main-net configuration (production) */
export const circlesConfig: CirclesConfig = {
  circlesRpcUrl:        'https://rpc.aboutcircles.com/',
  pathfinderUrl:        'https://pathfinder.aboutcircles.com',
  profileServiceUrl:    'https://rpc.aboutcircles.com/profiles/',
  v1HubAddress:         '0x29b9a7fbb8995b2423a71cc17cf9810798f6c543',
  v2HubAddress:         '0xc12C1E50ABB450d6205Ea2C3Fa861b3B834d13e8',   // hub on GC main-net [oai_citation:4‡docs.aboutcircles.com](https://docs.aboutcircles.com/developer-docs/getting-started-with-the-sdk)
